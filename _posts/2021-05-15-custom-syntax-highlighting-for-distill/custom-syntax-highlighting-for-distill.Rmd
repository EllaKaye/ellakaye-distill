...
```{r colour-harmonies, echo = FALSE, fig.cap = "Harmonious colour combinations. SAY MORE. ADD ALT TEXT"}
knitr::include_graphics("colour-harmonies.png")
```


**INSERT IMAGE HERE?**
<https://www.pngfind.com/mpng/wmmiiT_colour-harmonies-and-schemes-reference-card-colour-complementary/>

Another aspect of colour theory relates to colour spaces, and different ways that colours can be defined. The best known, at least in the context of designing for the web, is RGB (**R**eg **G**reen **B**lue), which defines a colour by how much of each of those three primary colours it contains, in a range of 0-255.
