...
description: |
  Resources and sites I found inspiring when building my new site, and a sneak-peak at an exciting new project for {distill} users
author:
  - name: Ella Kaye
    url: {}
date: 2021-05-08
...
- The blogpost from RStudio on [rRe-)introducting Distill for R Markdown](https://blog.rstudio.com/2020/12/07/distill/) is a great place to start.
...
- And one on [building a {distill} website](https://themockup.blog/posts/2020-08-01-building-a-blog-with-distill/) from Lisa Lendway

### Next steps

- The [{postcards}](https://github.com/seankross/postcards) package from Sean Kross makes it incredibly easy to create simple, styling, landing pages, and they make great home pages for {distill} sites. Alison Hill has a walk-through on how to set this up: [M-F-E-O](https://alison.rbind.io/post/2020-12-22-postcards-distill/)
...
I'm extremely grateful to the authors of the above posts for taking time to write up what they've developed and what they know/have learnt to do, therefore making it easy for others to apply. I guess that's what blogs are for! But I've also learnt a lot from finding sites that I simply like the look of, or have cool features, and looking at the source code on GitHub and adapting it for my own site. Here are some sites that I've drawn on for inspiration and code:
...
The above just scratches the surface. There are many more great sites built to {distill} out there, and lots more ways to customise them. Below are some good ways to find out more.

### The distillery

The [distillery]{https://distillery.rbind.io} is a {distill} blog about building {distill} blogs and websites ^[At the time of writing this post, the distillery appears to be down (some kind of certificate issue), but that will no doubt be resolved before too long]. As the site's GitHub README states:
...
Expect to hear much more from me, both on this blog and [twitter](https://twitter.com/ellamkaye), about this in the near future.
